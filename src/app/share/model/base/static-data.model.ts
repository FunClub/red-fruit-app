import {CircleData} from "../../../circle/model/circle-data.model";
export  const cities=["北京","上海","广州","重庆","湖南","湖北","四川","江苏","山西","福建"];
export  const professions=["学生","白领","全职太太","个体户","主播","老师","经理","厨师","老板","房东"];
export const hobbies=["打游戏","旅游","享受美食","睡觉","打球","看电影","棋牌"];
export const characters=["热性开朗","温柔体贴","热情似火","小家碧玉","大义凛然","老实憨厚","活泼可爱"];
export const albumType=["自拍","旅游","人物","随拍","生活","风景","恩爱照","纪念照"];
export const noteType=["心情","记事","生活","抒情","随笔","吐槽"];
export const limit=[
  {label:'公开到分享圈',value:1},
